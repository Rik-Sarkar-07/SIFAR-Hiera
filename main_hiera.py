...
def main(args):
    ...
    #print("Crops = ",args.num_crops)
    #print("Clips = ",args.num_clips)
    ...
    model = sifar_hiera.hiera_base_224(num_classes=args.num_classes, pretrained = True, strict = False, duration = args.duration, super_img_rows = args.super_img_rows)
    model.to(device)
    print(model)
    #import ipdb;
...
#args.gpu
    ...
    #print("train_list_name = ",train_list_name)
    #exit(0)
    ...
    train_augmentor = get_augmentor(True, args.input_size, mean, std, threed_data=args.threed_data,
                                    version=args.augmentor_ver, scale_range=args.scale_range, dataset=args.dataset, colorjitter=args.colorjitter, randomrotation=args.randomrotation, randomarg=args.randomarg)
    ...
    val_augmentor = get_augmentor(False, args.input_size, mean, std, args.disable_scaleup,
                                  ...
                                  scale_range=args.scale_range, num_clips=args.num_clips, num_crops=args.num_crops, dataset=args.dataset, colorjitter=args.colorjitter, randomrotation=args.randomrotation, randomarg=args.randomarg)
    ...
    directory = "/scratch/workspace/sudipta/Distributed-Heira/sifar-pytorch-heira/output"   # Replace with -->>> args.output_dir
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Heira training and evaluation script', parents=[get_args_parser()])
