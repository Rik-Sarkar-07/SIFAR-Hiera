...
class Hiera(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(
        self,
        input_size: Tuple[int, ...] = (896, 896),     # (672,672)
        in_chans: int = 3,
    ...
    def create_super_img(self, x):
        ...
        # Assuming x is your tensor of shape [32, 3, 672, 672]
        # Select one image (e.g., the first image)
        image = x[0]  # Shape: [3, 672, 672] of the super image


        # Save the image using torchvision's save_image function
        vutils.save_image(image, "/scratch/workspace/sudipta/img/With_out_RandomArgs.png")
...
# Image models (All PreTrained Models)
